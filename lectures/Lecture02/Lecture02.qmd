...
1. Re-analyze data in Excel
2. Re-create all charts
3. Copy-paste new charts into Word
4. Update text to match new numbers
5. Hope you don't miss anything!
...
If we would like to describe the average age of the patients in text using the expression below:

```{r}
#| label: example-with-data
#| eval: false

The average patient age is `r mean(patient_age)` years.
```

We have the rendered output like:
...
3. **Keep this document open** - you'll add code to it as we go through Parts 2-4
