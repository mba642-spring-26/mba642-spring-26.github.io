...
# Loading the dataset
surgical_data <- read.csv("./week12_surgical_data.csv")
...
hospital_type_data <- read.csv("./week12_hospital_type_data.csv")
...
# Load the dataset
satisfaction_data <- read.csv("./week12_satisfaction_data.csv")
...
# load data
diabetes_data <- read.csv("./week12_diabetes_data.csv")
...
pt_data <- read.csv("./week12_pt_data.csv")
head(pt_data, 5)
```
...
quality_data <- read.csv("./week12_quality_data.csv")
head(quality_data, 5)
```
